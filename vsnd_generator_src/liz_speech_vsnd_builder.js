...
function getClipObject(assetName, speechTag, type, sentiment, intensity, overrides) {
	return {
		name: null,
		assetName,
...
fs.existsSync('./vsnd_generator_build') || fs.mkdirSync('./vsnd_generator_build');
fs.writeFileSync('./vsnd_generator_build/liz_vsnd_snippet.txt', vsndFile, 'utf-8');
fs.writeFileSync('./vsnd_generator_build/liz_typescript_snippet.ts', tsFile, 'utf-8');
